...
from .mixins import ListRetrieveGeneric
from online_service.models import (Cart, Favorite, Ingredient,
...
class IngredientViewSet(ListRetrieveGeneric):
...
class RecipeViewSet(viewsets.ModelViewSet):
    ...
    def favorite_or_cart(self, request, id, model, message_not_in,
                         message_in, class_serializer):
        user = request.user
